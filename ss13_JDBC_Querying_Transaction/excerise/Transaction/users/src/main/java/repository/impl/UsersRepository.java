...
public class UsersRepository implements IUsersRepository {
    ...
    public String addUserTransaction() {
        ...
        try {
            ...
            PreparedStatement preparedStatementUser = connection.prepareStatement("insert into users(name,email,country) value(?,?,?);");
            preparedStatementUser.setString(1,"Hùng");
            preparedStatementUser.setString(2,"hungdn");
