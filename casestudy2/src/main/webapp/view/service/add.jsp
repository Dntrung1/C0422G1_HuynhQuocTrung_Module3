...
<form action="/Furama?action=add" method="post" class="p-5  shadow w-50 container-fluid mt-3">
    <select class="form-select" aria-label="Default select example" name="code" id="selectService" onchange="displayInput()">
    ...
    <div class="mb-3 mt-3" style="display: none" id="divDescriptionOtherConvenience">
        ...
        <input type="text" class="form-control" id="descriptionOtherConvenience" placeholder="Enter descriptionOtherConvenience" name="descriptionOtherConvenience">
    </div>
    ...
    <div class="mb-3 mt-3" style="display: none" id="divNumberOfFloors">
        ...
        <input type="number" class="form-control" id="numberOfFloors" placeholder="Enter numberOfFloors" name="numberOfFloors">
    </div>
