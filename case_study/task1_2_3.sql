...
values (1,'Villa Beach Front',25000,1000000,10,'vip','Có hồ bơi',500,4,3,1),
(4,'Villa No Beach Front',22000,9000000,8,'normal','Có hồ bơi',300,4,3,1);
insert into dich_vu (ma_dich_vu,ten_dich_vu,dien_tich,chi_phi_thue,so_nguoi_toi_da,tieu_chuan_phong,mo_ta_tien_nghi_khac,so_tang,ma_kieu_thue,ma_loai_dich_vu)
value (2,'House Princess 01',14000,5000000,7,'vip','Có thêm bếp nướng',3,2,2),
(5,'House Princess 02',10000,4000000,5,'normal','Có thêm bếp nướng',2,2,2);
insert into dich_vu (ma_dich_vu,ten_dich_vu,dien_tich,chi_phi_thue,so_nguoi_toi_da,tieu_chuan_phong,mo_ta_tien_nghi_khac,dich_vu_mien_phi_di_kem,ma_kieu_thue,ma_loai_dich_vu)
values (3,'Room Twin 01',5000,1000000,2,'normal','Có tivi','1 Xe máy, 1 Xe đạp',4,3),
(6,'Room Twin 02',3000,900000,2,'normal','Có tivi','1 Xe máy',4,3);
